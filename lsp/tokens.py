...
def did_open(ls: TokensServer, params: types.DidOpenTextDocumentParams):
...
def did_change(ls: TokensServer, params: types.DidOpenTextDocumentParams):
...
def semantic_tokens_full(ls: TokensServer, params: types.SemanticTokensParams):
    data = []
